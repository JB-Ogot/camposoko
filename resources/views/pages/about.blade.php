      ...
      <!-- <div class="container"> -->
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            ...
            {{-- <a data-link-tracking="Header|MainLogo|Image|men" id="logo" href="/">Camposoko</a> --}}
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <h3 class="h4">James B Ogot</h3>
            <p class="caption mb-3 text-primary">Developer</p>
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <h3 class="h4">Faith Mwende</h3>
            <p class="caption mb-3 text-primary">Chief Operations Officer</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore animi quam, est vero. Omnis sunt, totam qui!</p>
          </div>
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            <img src="images/person_4.jpg" alt="Image" class="img-fluid mb-3">
            <h3 class="h4">Juma Bonface</h3>
            <p class="caption mb-3 text-primary">Marketing Strategist</p>
