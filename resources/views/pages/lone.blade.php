                                ...
                                <div class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                          ...
                                          {{-- <div class="carousel-item">
                                                <img class="card-img" src="{{ asset('storage/ads/'.$image = json_decode($post->imgUrl1)[1]) }}"  alt="Not found" style="width:100%;">
                                          </div>
                                          <div class="carousel-item">
                                                <img class="card-img" src="{{ asset('storage/ads/'.$image = json_decode($post->imgUrl1)[2]) }}"  alt="Not found" style="width:100%;">
                                          </div> --}}
                                        </div>
