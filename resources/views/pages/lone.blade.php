                        ...
                        <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li>
                                <img src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAkGBw8QDw0TEw4NFRMXDRUQEhAPEA8NDxUPFREWFhUXHxUY
                                            ...
                                            BQUoCAggQAgIKgIMHrFYZFRLf0eXNNKes7NQtenxD8ZC4zRnexLpGre78KmFW1rZVLliAEECAgICAgIKghQVBEH/9k="
                                    width="40" alt="">
                            </li>
                            @endif
                            ...
                            <div class="carousel slide" data-ride="carousel" data-interval="2000">
                                        <div class="carousel-inner">
                                          <div class="carousel-item active">
                                                <img class="card-img" src="{{ asset('storage/ads/'.$image = json_decode($post->imgUrl1)[0]) }}"
                            alt="Not found" style="width:100%;">
                        </div>
                        <div class="carousel-item">
                                                <img class="card-img" src="{{ asset('storage/ads/'.$image = json_decode($post->imgUrl1)[1]) }}"
                        alt="Not found" style="width:100%;">
                    </div>
                    <div class="carousel-item">
                        <img class="card-img" src="{{ asset('storage/ads/'.$image = json_decode($post->imgUrl1)[2]) }}"
                            alt="Not found" style="width:100%;">
                    </div>
                    </div>
                    ...
                    <div class="card-body listing">
                        <div class="lh-content">
                            ...
                            <div class="price text-success">
                                <h5 class="mt-4">Ksh.{{$post->price}}</h5>
                            </div>
