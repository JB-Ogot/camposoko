...
<head>
    ...
    <script data-ad-client="ca-pub-7173197345625982" async
...
<body>
    ...
    <div class="site-wrap">
        ...
        <div class="site-blocks-cover overlay aos-init aos-animate"
            style="background-image: url(&quot;images/home.jpg&quot;); background-position: 50% -25px;" data-aos="fade"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row justify-content-center mb-4">
                            <div class="col-md-8 text-center">
                                <h1 class="aos-init aos-animate" data-aos="fade-up">The Largest Market In The Campus
                                    World</h1>
                        ...
                        <div class="col-md-12 d-flex justify-content-center align-content-center">
                            <div class="form-search-wrap d-flex justify-content-center col-md-10 aos-init aos-animate"
                                    ...
                                    <div class="col-md-12 d-flex justify-content-center align-content-center">
                                        <div class="col-lg-12 mb-4 mb-xl-0 col-xl-4 col-md-9">
                                            <input type="text" name='search' class="form-control rounded"
                                                onfocus="this.value=''" value="What are you looking for?">
                                        </div>
            ...
            <div class="overlap-category mb-5">
              <div class="row align-items-stretch no-gutters">
                ...
                <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                      ...
                      <span class="caption mb-2 d-block">Food &amp; Restaurants</span>
                        <span class="number">{{$food}}</span>
                        </a>
                      </div>
                ...
                <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                        <a href="/single/bars" class="popular-category h-100">
                          <i class="fa fa-wine-glass fa-4x"></i>
                    ...
                    <div class="col-12  block-13">
                        <div class="owl-carousel nonloop-block-13">
                            ...
                            <div class="d-block d-md-flex listing vertical">
                                <a href="/posts/single/{{$post->id}}" class="img d-block">
                                    <img src="{{ asset('storage/ads/'.$img = json_decode($post->imgUrl1)[0]) }}"
                                        alt="not found" class="responsive">
                                </a>
                            ...
                            <h3><strong><b>{{$post->pname}}</b></strong></h3>
                                    <div class="price text-success"><h5 class="mt-4"><b>Ksh.{{$post->price}}</b></h5></div>
